        ...
        <div class="canvas">
          ...
          <div class="overlay">
            ...
            ${pvLabelLineItems.map(ln => html`
              ...
              <div style="position:absolute; left:${ln.x}%; top:${ln.yBus}%; width:2px; height:${(8 / viewHeight) * 100}%; background:${ln.color}; opacity:${ln.opacity}; filter:${ln.glow}; pointer-events:none; border-radius:0 0 4px 4px;"></div>
            `)}
